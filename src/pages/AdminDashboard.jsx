    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 gap-4">
        <button 
          ...
          className={`p-6 rounded-xl shadow-sm flex items-center justify-between transition ${isDark ? 'bg-gray-800 hover:bg-gray-700 border border-yellow-900' : 'bg-white hover:shadow-md border border-yellow-100'}`}
        >
          <div className="text-left">
            <h3 className={`text-lg font-bold text-yellow-600`}>🛠️ 線上報修與採購系統</h3>
            <p className={`text-sm ${subTextColor}`}>全校維修進度追蹤、採購單與結案管理</p>
          </div>
